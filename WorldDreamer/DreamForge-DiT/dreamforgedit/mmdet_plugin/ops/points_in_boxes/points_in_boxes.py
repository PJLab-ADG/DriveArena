...
from . import points_in_boxes_ext
...
def points_in_boxes_gpu(points, boxes):
    ...
    points_in_boxes_ext.points_in_boxes_gpu(
...
def points_in_boxes_cpu(points, boxes):
    ...
    points_in_boxes_ext.points_in_boxes_cpu(
...
def points_in_boxes_batch(points, boxes):
    ...
    points_in_boxes_ext.points_in_boxes_batch(
        boxes.contiguous(), points.contiguous(), box_idxs_of_pts
    )
