...
frame_interval = 1
save_fps = 12
validation_index = 'scene_110' # You can change the scene index here.
num_sample = 1
...
dataset_cfg_overrides = (
    ...
    # ("dataset.data.val.start_on_keyframe", False),
)
...
model_single = dict(
    ...
    use_ope=True,
    # load pretrained
    from_pretrained="./pretrained/DreamForgeDiT-s/ema.pt",
...
# Log settings
seed = 42
outputs = "outputs/test/CogVAE-r17-448x800"
wandb = False
epochs = 150
log_every = 1
ckpt_every = 500 * 5
