...
from .transformer_2d import MultiviewTransformer2DModel


class UNet2DConditionModelMultiviewScene(UNet2DConditionModel):
    r"""
    ...
    def __init__(
        ...
        for name, mod in list(self.named_modules()):
            if isinstance(mod, Transformer2DModel):
                _set_module(self, name, MultiviewTransformer2DModel(
                    **mod._args,
