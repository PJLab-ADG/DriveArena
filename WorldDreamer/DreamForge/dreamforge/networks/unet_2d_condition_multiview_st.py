...
from .unet_2d_condition_multiview_s import (
    UNet2DConditionModelMultiviewScene,
    UNet2DConditionOutput
)


class UNet2DConditionModelMultiviewSceneT(UNet2DConditionModelMultiviewScene):
    r"""
    ...
    def __init__(
        ...
        for name, mod in list(self.named_modules()):
            if isinstance(mod, MultiviewTransformer2DModel):
                _set_module(self, name, TemporalMultiviewTransformer2DModel(
                    **mod._args,
                    zero_module_type2=zero_module_type2,
                    video_length=video_length,
                    temp_pos_emb=temp_pos_emb,
