...
class VAD(MVXTwoStageDetector):
    ...
    def forward_test(
        ...
        **kwargs
        ...
        new_prev_bev, bbox_results = self.simple_test(
            ...
            gt_attr_labels=None,#=gt_attr_labels,
            **kwargs
        )
    ...
    def simple_test_pts(
        ...
        with torch.no_grad():
            ...
            # breakpoint()
            # gt_label = gt_labels_3d[0].to('cpu').item()
            ...
            #     pred_ego_fut_trajs = ego_fut_pred[None], # gt_traj
            #     gt_ego_fut_trajs = ego_fut_trajs[None], # pred traj
    ...
    def assign_pred_to_gt_vip3d(
        ...
        matched_bbox_result = torch.ones(
            (1), dtype=torch.long) * -1  # -1: not assigned len(gt_bbox)
        gt_centers = gt_bbox[None, :2].to('cpu')
