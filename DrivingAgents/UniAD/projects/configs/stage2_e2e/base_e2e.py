...
model = dict(
    ...
    motion_head=dict(
        ...
        anchor_info_path='data_temp/others/motion_anchor_infos_mode6.pkl',
        transformerlayers=dict(
...
data_root = "/cpfs01/shared/public/ADLab/datasets/nuscenes"
...
test_pipeline = [
    ...
    dict(type='LoadMultiViewImageFromFilesInCeph', to_float32=True,
            file_client_args=file_client_args, img_root='/cpfs01/user/yangxuemeng/code/MagicDrive-t-share-clean/0720_MD_gen_nusc_imgs', upsample=True),
    dict(type="NormalizeMultiviewImage", **img_norm_cfg),
    dict(type="PadMultiViewImage", size_divisor=32),
