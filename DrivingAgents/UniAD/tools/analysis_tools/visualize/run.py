...
class Visualizer:
    ...
    def __init__(
            self,
            dataroot='/cpfs01/shared/public/ADLab/datasets/nuscenes/',
...
def main(args):
    ...
    viser = Visualizer(version='v1.0-trainval', predroot=args.predroot, dataroot='/cpfs01/shared/public/ADLab/datasets/nuscenes/', **render_cfg)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--predroot', default='output/results_single_data.pkl', help='Path to results.pkl')
    parser.add_argument('--out_folder', default='output/demo_test/', help='Output folder path')
