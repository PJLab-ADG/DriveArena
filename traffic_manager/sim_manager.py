...
from traffic_manager.utils.sim_utils import limsim2diffusion, normalize_angle, transform_to_ego_frame, interpolate_traj
...
from traffic_manager.utils.matplot_render import MatplotlibRenderer
from LimSim.simInfo.CustomExceptions import CollisionChecker, OffRoadChecker
from traffic_manager.utils.scorer import Scorer
...
class SimulationManager:
    ...
    def initialize_simulation(self):        
        ...
        self.model.start()
        self.planner = TrafficManager(self.model, config_file_path='./traffic_manager/LimSim/trafficManager/config.yaml')
